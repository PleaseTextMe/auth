...
@pytest.mark.asyncio
async def test_exception_handler_user_not_found():
...
@pytest.mark.asyncio
async def test_exception_handler_email_already_exists():
...
@pytest.mark.asyncio
async def test_exception_handler_username_already_exists():
...
@pytest.mark.asyncio
async def test_exception_handler_verify_code_not_confirmed():
